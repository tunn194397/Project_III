...
export default function SearchBarWithCreatePage(props: any) {
    const {filterArray, handleAdd, addPermission} = props;

    return (
        <div className='flex flex-row space-x-5 mx-6'>
            ...
            {addPermission && <div className='flex flex-col-reverse space-y-2'>
                <button className='flex flex-row space-x-2 items-center bg-green-500 hover:ring-4 hover:ring-green-300 px-2 py-2 rounded-lg text-white font-bold' onClick={() => handleAdd(true)}>
