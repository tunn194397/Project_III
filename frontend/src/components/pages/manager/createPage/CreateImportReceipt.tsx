    ...
    useMemo(() => {
        (async () => {
            ...
            const itemOptions = items.data.result.map((e: any) => {
                return {value: e.id, message: e.name + e.productionCode, label: e.name + e.productionCode, image: e.image, price: e.price }
            })
                                ...
                                <div className='flex flex-col bg-white space-y-5 py-5' key={domain.domain}>
                                    ...
                                    <div className='grid grid-cols-1 gap-5'>
                                        {domain.fields.map((e: any ) => {
                                            return (
                                                <div key={e.field} className='w-full space-y-1 flex flex-row space-x-10 items-center' >
                                    ...
                                    return (
                                        <div className='grid grid-cols-12 bg-white space-y-2 border-2 border-gray-200 items-center' key={domain.domain}>
                                            ...
                                            <div className='col-span-2 px-2 py-2'>
                                                <div>
                                                    <input
                                                        className="border rounded py-2 px-3 text-gray-700 outline-none text-sm focus:border-blue-500 focus:border-2"
                                                        type="number"
                                                        min={0}
